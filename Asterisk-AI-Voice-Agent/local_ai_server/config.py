...
class LocalAIConfig:
    ...
    # When false, Silero returns raw PCM16 mono at delivery rate instead of μ-law 8 kHz (less hiss).
    silero_tts_ulaw_output: bool = True
    # Optional resample before returning PCM (e.g. synthesize at 24000, deliver 16000 for wideband AudioSocket).
    silero_tts_delivery_sample_rate: Optional[int] = None
    ...
    def from_env(cls) -> "LocalAIConfig":
        ...
        return cls(
            ...
            silero_tts_ulaw_output=_parse_bool(os.getenv("SILERO_TTS_ULAW_OUTPUT", "true"), default=True),
            silero_tts_delivery_sample_rate=_parse_optional_int(os.getenv("SILERO_TTS_DELIVERY_SAMPLE_RATE")),
