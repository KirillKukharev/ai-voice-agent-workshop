...
VOSK_STT_MODELS = [
    ...
    {"id": "vosk_ru_small", "name": "Russian Small", "language": "ru-RU", "region": "europe", "backend": "vosk",
     ...
     "download_url": "https://huggingface.co/rhasspy/vosk-models/resolve/main/ru/vosk-model-small-ru-0.22.zip",
     "is_archive": True, "archive_type": "zip"},
...
TONE_STT_MODELS = [
    {"id": "tone_ru", "name": "T-one Russian (Streaming CTC)", "language": "ru-RU", "region": "europe", "backend": "tone",
     ...
     # Explicit fallbacks; wizard also auto-tries hf-mirror for any huggingface.co URL
     "download_url_fallbacks": [
         "https://hf-mirror.com/t-tech/T-one/resolve/main/model.onnx",
     ],
     "recommended": True,
     "description": "Native T-one acoustic model for Russian telephony streaming.",
     "note": "Requires INCLUDE_TONE=true in Docker build. If huggingface.co fails, Admin UI retries hf-mirror.com; or: huggingface-cli download t-tech/T-one --local-dir models/stt/t-one",
     },
    {"id": "tone_ru_kenlm", "name": "T-one Russian KenLM", "language": "ru-RU", "region": "europe", "backend": "tone",
     ...
     "download_url_fallbacks": [
         "https://hf-mirror.com/t-tech/T-one/resolve/main/kenlm.bin",
     ],
