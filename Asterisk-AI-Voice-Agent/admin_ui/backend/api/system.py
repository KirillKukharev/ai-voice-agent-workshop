...
class UpdateRunRequest(BaseModel):
    ...
    # When True, updater passes --skip-check (no agent check after update; use if Asterisk/ARI is down).
...
async def updates_run(body: UpdateRunRequest):
    ...
    try:
        ...
        payload = {
            ...
            "skip_check": bool(body.skip_check),
        }
    ...
    env = {
        ...
        "AAVA_UPDATE_SKIP_CHECK": "true" if body.skip_check else "false",
    }
