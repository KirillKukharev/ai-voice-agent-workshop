                    ...
                    <div className="space-y-6">
                        <FormSelect
                            ...
                            options={[
                                ...
                                { value: 'force_true', label: 'Swap (force byte swap for PCM16)' },
                                { value: 'force_false', label: 'None (no byte swap)' },
                                { value: 'disabled', label: 'Disabled' }
                            ]}
                            tooltip="PCM16 byte order for playback. If TTS sounds like noise/static, try 'Swap' or switch AudioSocket format to μ-law in Transport / AudioSocket tab."
                        />
                        <FormSwitch
