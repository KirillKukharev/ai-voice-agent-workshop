...
_runtime_version.ValidateProtobufRuntimeVersion(_runtime_version.Domain.PUBLIC, 6, 31, 0, "", "stt_service.proto")
...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals["_GETRECOGNITIONREQUEST"].fields_by_name[
        "operation_id"
    ]._serialized_options = b"\350\3071\001\212\3101\004<=50"
    _globals["_ASYNCRECOGNIZER"].methods_by_name["RecognizeFile"]._loaded_options = None
    _globals["_ASYNCRECOGNIZER"].methods_by_name[
        "RecognizeFile"
    ]._serialized_options = (
        b'\262\322*\027\022\025google.protobuf.Empty\202\323\344\223\002\037"\032/stt/v3/recognizeFileAsync:\001*'
    )
    _globals["_ASYNCRECOGNIZER"].methods_by_name["GetRecognition"]._loaded_options = None
    _globals["_ASYNCRECOGNIZER"].methods_by_name[
        "GetRecognition"
    ]._serialized_options = b"\202\323\344\223\002\030\022\026/stt/v3/getRecognition"
    _globals["_ASYNCRECOGNIZER"].methods_by_name["DeleteRecognition"]._loaded_options = None
    _globals["_ASYNCRECOGNIZER"].methods_by_name[
        "DeleteRecognition"
    ]._serialized_options = b"\202\323\344\223\002\033*\031/stt/v3/deleteRecognition"
    _globals["_GETRECOGNITIONREQUEST"]._serialized_start = 237
    _globals["_GETRECOGNITIONREQUEST"]._serialized_end = 296
    _globals["_RECOGNIZER"]._serialized_start = 298
    _globals["_RECOGNIZER"]._serialized_end = 411
    _globals["_ASYNCRECOGNIZER"]._serialized_start = 414
    _globals["_ASYNCRECOGNIZER"]._serialized_end = 845
